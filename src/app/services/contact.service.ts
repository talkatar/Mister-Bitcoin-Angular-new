...
export class ContactService {
    ...
    private _contactFilter$ = new BehaviorSubject<ContactFilter>({ name: '', phone:'' });
    ...
    public loadContacts() {
        return from(storageService.query(ENTITY))
            .pipe(
                tap(contacts => {
                    console.log(storageService.query(ENTITY));
                    ...
                    contacts = contacts.filter(contact =>  typeof contact.phone === 'string' && contact.phone.includes(filterBy.phone));
